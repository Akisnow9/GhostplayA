...
public class Player : MonoBehaviour
{
    ...
    [SerializeField] private GameObject m_itemAttachPoint;
    [SerializeField] private GameObject m_playerShirt;
    private GameObject m_hat;
    private e_Hats m_hatID;
    [SerializeField] private GameObject m_attachPoint;
        ...
        //else
        {
            ...
            if (axisX != 0 || axisY != 0) // checks if there is an axis input.
            {
                ...
                if (Mathf.Abs(axisX) > Mathf.Abs(axisY))
                    m_animator.SetFloat("RunningSpeed", Mathf.Abs(axisX));
                else
                    m_animator.SetFloat("RunningSpeed", Mathf.Abs(axisY));
    ...
    private void MoveItem()
    {
        ...
        m_heldItem.transform.position = m_itemAttachPoint.transform.position;
        m_heldItem.transform.rotation = m_itemAttachPoint.transform.rotation; // follows the rotation of the player
    }
